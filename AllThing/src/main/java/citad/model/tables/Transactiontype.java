...
public class Transactiontype extends TableImpl<TransactiontypeRecord> {
    ...
    private static final long serialVersionUID = -1168779869;
     ...
     */
    public final TableField<TransactiontypeRecord, String> TRANSACTIONTYPE_ = createField("transactionType", org.jooq.impl.SQLDataType.VARCHAR.length(32).nullable(false), this, "");
