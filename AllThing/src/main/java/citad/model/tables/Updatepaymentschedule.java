...
public class Updatepaymentschedule extends TableImpl<UpdatepaymentscheduleRecord> {
    ...
    private static final long serialVersionUID = 1859074936;
    ...
    /**
     * The column <code>transaction.updatePaymentSchedule.debitAccount</code>.
     */
    public final TableField<UpdatepaymentscheduleRecord, String> DEBITACCOUNT = createField("debitAccount", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
